        ...
        Column(Modifier.padding(it)) {
            TabRow(
                ...
                Tab(
                    ...
                    text = { Text(
                        "New Trips",
                        style = if (selectedTab == 0) MaterialTheme.typography.headlineSmall else MaterialTheme.typography.bodyLarge,
                ...
                Tab(
                    ...
                    text = { Text(
                        "Completed Trips",
                        style = if (selectedTab == 1) MaterialTheme.typography.headlineSmall else MaterialTheme.typography.bodyLarge,
